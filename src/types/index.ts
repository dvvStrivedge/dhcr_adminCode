...
export interface Product {
  ...
  technical_specs_name?: string;
  technical_specs_description?: string;
  created_at: string;
  updated_at: string;
  ratings: number;
  shop?: Shop;
...
export interface CreateIncludeInput {
  name: string;
  type?: ConnectTypeBelongsTo;
  details?: string;
  image?: AttachmentInput;
...
export interface FeatureQueryOptions extends QueryOptions {
  type: string;
  name: string;
  parent: number | null;
}

export interface pickupLocationQueryOptions extends QueryOptions {
  type: string;
  name: string;
  parent: number | null;
}

export interface includeQueryOptions extends QueryOptions {
  type: string;
  name: string;
  parent: number | null;
}
...
export interface PendingOrderQueryOptions extends QueryOptions {
  type: string;
  name: string;
  shop_id: string;
  tracking_number: string;
...
export interface FeaturePaginator extends PaginatorInfo<Feature> { }

export interface PickupLocationPaginator extends PaginatorInfo<PickupLocation> { }

export interface IncludePaginator extends PaginatorInfo<Include> { }
