  ...
  return (
    <div className="my-5 flex flex-wrap sm:my-8">
      ...
      <Card className="w-full sm:w-8/12 md:w-2/3">
        ...
        <InputGroup
          label={t('form:input-label-3-days-discount')}
          type="number"
          {...register('three_days_discount')}
          // error={t(errors ?.3_days_discount?.message!)}
          variant="outline"
          className="mb-5"
        />

        <InputGroup
          label={t('form:input-label-1-week-discount')}
          type="number"
          {...register('one_week_discount')}
          // error={t(errors ?.5_days_discount?.message!)}
          variant="outline"
          className="mb-5"
        />

        <InputGroup
          label={t('form:input-label-1-month-discount')}
          type="number"
          {...register('one_months_discount')}
          // error={t(errors ?.5_days_discount?.message!)}
          variant="outline"
          className="mb-5"
        />
