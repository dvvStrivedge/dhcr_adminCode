...
const PendingOrders = ({ orders, title }: IProps) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (tracking_number: string) => (
                <a href={`orders/${tracking_number}`}>{tracking_number}</a>
            ),
        },
        {
        ...
        },
        {
            ...
            render: (order_status: OrderStatus) => (
                <Badge text={replaceString(order_status)} color={StatusColor(order_status)} />
            ),
        },
    ];
