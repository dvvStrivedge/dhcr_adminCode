...
const FeatureDeleteView = dynamic(() => import('@/components/feature/feature-delete-view'));
const PickupLocationDeleteView = dynamic(
  () => import('@/components/pickup_location/pickup-location-delete-view')
);
const IncludeDeleteView = dynamic(
  () => import('@/components/includes/include-delete-view')
);
...
function renderModal(view: MODAL_VIEWS | undefined, data: any) {
  switch (view) {
    ...
    case 'DELETE_FEATURE':
      return <FeatureDeleteView />;
    case 'DELETE_LOCATION':
      return <PickupLocationDeleteView />;
    case 'DELETE_INCLUDE':
      return <IncludeDeleteView />;
